...
This means the plugin works standalone — you do not need the [opencode workspace tool](https://rmkohlman.github.io/devopsmaestro/dvm/opencode/) to use it. You do need an API key in your environment.
...
See [API key configuration](https://rmkohlman.github.io/devopsmaestro/dvm/opencode/#api-key-configuration) in the workspace tool guide for how to manage keys with `dvm create credential`.
...
See [opencode CLI Tool](https://rmkohlman.github.io/devopsmaestro/dvm/opencode/) for workspace tool setup details.
...
- [opencode CLI Tool](https://rmkohlman.github.io/devopsmaestro/dvm/opencode/) — Workspace tool setup
- [Plugins Reference](library.md) — Managing nvp plugins
